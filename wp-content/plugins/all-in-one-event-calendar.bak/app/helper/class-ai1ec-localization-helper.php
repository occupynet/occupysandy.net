...
/**
 * Localization backends manager
 *
 * @author     Justas Butkus <justas@butkus.lt>
 * @since      2012.11.15
 *
 * @package    AllInOneCalendar
 * @subpackage AllInOneCalendar.Helper.L10n
 */
class Ai1ec_Localization_Helper {
	/**
	 * @var NULL|Ai1ec_Localization_Helper Instance of self
	 **/
	 ...
	 *
	 * @return Ai1ec_Localization_Helper
	 **/
