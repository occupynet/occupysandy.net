...
class Ai1ec_Facebook_Current_User {
	...
	/**
	 * 
	 * @var bool Whereas comments are enabled for current user
	 */
	private $_enable_comments;

	/**
	 * 
	 * @var bool Whereas map shall be displayed for current user
	 */
	...
	/**
	 * @return bool $this->_enable_comments
	 */
	public function get_enable_comments() {
		return $this->_enable_comments;
	}

	/**
	 * @return bool $this->_display_map
	 */
	public function get_display_map() {
		return $this->_display_map;
	}
