  ...
  */
  ...
  public function check_field_date() {
    ...
    if ( $this->has_field( 'date' ) && $this->is_edit_page() ) {
      ...
      wp_enqueue_style(
        'tmc-jquery-ui-css',
        '//ajax.googleapis.com/ajax/libs/jqueryui/' . $this->get_jqueryui_ver() . '/themes/base/jquery-ui.css'
      );
      wp_enqueue_script(
        'tmc-jquery-ui',
        '//ajax.googleapis.com/ajax/libs/jqueryui/' . $this->get_jqueryui_ver() . '/jquery-ui.min.js',
        array( 'jquery' )
      );
    }
  ...
  public function check_field_time() {
    ...
    if ( $this->has_field( 'time' ) && $this->is_edit_page() ) {
      ...
      wp_enqueue_script(
        'at-timepicker',
        '//github.com/trentrichardson/jQuery-Timepicker-Addon/raw/master/jquery-ui-timepicker-addon.js',
        array( 'tmc-jquery-ui' ),
        false,
        true
      );
